...
module GraphHopper
  class SolutionApi
    ...
    def get_solution_with_http_info(key, job_id, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'key' when calling SolutionApi.get_solution" if key.nil?
      # verify the required parameter 'job_id' is set
      fail ArgumentError, "Missing the required parameter 'job_id' when calling SolutionApi.get_solution" if job_id.nil?
      # resource path
      local_var_path = "/solution/{jobId}".sub('{format}','json').sub('{' + 'jobId' + '}', job_id.to_s)
