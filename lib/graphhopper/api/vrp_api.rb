...
module GraphHopper
  class VrpApi
    ...
    def post_vrp_with_http_info(key, body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'key' when calling VrpApi.post_vrp" if key.nil?
      # verify the required parameter 'body' is set
      fail ArgumentError, "Missing the required parameter 'body' when calling VrpApi.post_vrp" if body.nil?
      # resource path
      local_var_path = "/optimize".sub('{format}','json')
