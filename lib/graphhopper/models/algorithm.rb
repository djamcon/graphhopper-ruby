...
module GraphHopper
  ...
  class Algorithm
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'problem_type')
    ...
    def valid?
      problem_type_validator = EnumAttributeValidator.new('String', ["min", "min-max"])
      return false unless problem_type_validator.valid?(@problem_type)
      objective_validator = EnumAttributeValidator.new('String', ["transport_time", "completion_time"])
    ...
    def problem_type=(problem_type)
      validator = EnumAttributeValidator.new('String', ["min", "min-max"])
      unless validator.valid?(problem_type)
        fail ArgumentError, "invalid value for 'problem_type', must be one of #{validator.allowable_values}."
      end
      @problem_type = problem_type
    end
    ...
    def objective=(objective)
      validator = EnumAttributeValidator.new('String', ["transport_time", "completion_time"])
