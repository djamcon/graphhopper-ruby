...
module GraphHopper
  ...
  class Response
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('String', ["waiting_in_queue", "processing", "finished"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["waiting_in_queue", "processing", "finished"])
